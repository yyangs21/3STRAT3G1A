...
st.title("📊 Dashboard Estratégico y de Control 2023 - PRO")
...
obj_resumen_filtrado = obj_resumen[obj_resumen["estado_ejecutivo"].isin(filtro_estado)]
...
c1.metric("Objetivos", obj_resumen_filtrado.shape[0])
...
# 3️⃣ HEATMAP CUMPLIMIENTO OBJETIVO X MES
...
# 4️⃣ LINEA TENDENCIA CUMPLIMIENTO PROMEDIO MENSUAL
...
# 5️⃣ BARRAS POR AREA Y RESPONSABLE
